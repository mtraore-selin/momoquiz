...
export class PlayerlistComponent implements OnInit {
  ...
  public doughnutColors = [{ backgroundColor: ['#8B0000', '#006400'] }];
  index: any;
  goldMedalIcon = faMedal;
  silverMedalIcon = faMedal;
  bronzeMedalIcon = faMedal;
  ...
  ngOnInit() {
    ...
    this.reportsservice.getPlayers(this.challengeId).subscribe(
      (res) => {
